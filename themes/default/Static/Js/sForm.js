...
$.fn.ajaxSubmit = function(options) {
    ...
    if (options.data) {
        ...
        qx = this.param(options.data, traditional);
    }
    ...
    var q = this.param(a, traditional);
    if (qx) {
        q = ( q ? (q + '&' + qx) : qx );
    }    
                ...
                if (s.extraData) {
                    for (var n in s.extraData) {
                        if (s.extraData.hasOwnProperty(n)) {
                           // if using the this.param format that allows for multiple values with the same name
